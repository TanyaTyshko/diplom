...
public class PurchaseOnCreditTest {
    ...
    @Test
    @DisplayName("01: Купить в кредит. Ввод валидных данных в поля «Номер карты», «Месяц», «Владелец», «Год», «CVC/CVV»")
    void shouldBePaidByApprovedCard() {
        startPage.clickButtonBuyWithCreditCard();
    ...
    @Test
    @DisplayName("02: Купить в кредит. Отказ в оплате при вводе номера отклонённой карты")
    ...
    @Test
    @DisplayName("03: Купить в кредит. Ввод невалидных данных в поле «Месяц»")
    ...
    @Test
    @DisplayName("04: Купить в кредит. Оставить поля «Номер карты», «Месяц», «Владелец», «Год», «CVC/CVV» незаполненными")
    ...
    @Test
    @DisplayName("05: Купить в кредит. Оставить поле «Номер карты» незаполненным")
    ...
    @Test
    @DisplayName("06: Купить в кредит. Оставить поле «Месяц» незаполненным")
    ...
    @Test
    @DisplayName("07: Купить в кредит. Оставить поле «Владелец» незаполненным")
    ...
    @Test
    @DisplayName("08: Купить в кредит. Оставить поле «Год» незаполненным")
    ...
    @Test
    @DisplayName("09: Купить в кредит. Оставить поле «CVC/CVV» незаполненным")
    ...
    @Test
    @DisplayName("10: Купить в кредит. Ввод невалидных данных в поле «Год», карта просрочена на год")
    ...
    @Test
    @DisplayName("11: Купить в кредит. Ввод невалидных данных в поле «Год», срок действия карты больше 5 лет")
    ...
    @Test
    @DisplayName("12: Купить в кредит. Ввод некорректных данных в поле «Год», ввод одной цифры вместо двух")
    ...
    @Test
    @DisplayName("13: Купить в кредит. Ввод некорректных данных в поле «CVC/CVV», ввод одной цифры вместо трех")
    ...
    @Test
    @DisplayName("14: Купить в кредит. Ввод невалидных данных в поле «Месяц», ввод одной цифры вместо двух")
    ...
    @Test
    @DisplayName("15: Купить в кредит. Ввод невалидных данных в поле «Номер карты», ввод 15 цифр вместо 16")
    ...
    @Test
    @DisplayName("16: Купить в кредит. Ввод невалидных данных в поле «Год», ввод двух нулей (00)")
    ...
    @Test
    @DisplayName("17: Купить в кредит. Ввод невалидных данных в поле «Месяц», ввод двух нулей (00)")
    ...
    @Test
    @DisplayName("18: Купить в кредит. Ввод трёх нулей (000) в поле «CVC/CVV»")
    ...
    @Test
    @DisplayName("19: Купить в кредит. Ввод 16 нулей (0000 0000 0000 0000) в поле «Номер карты»")
    ...
    @Test
    @DisplayName("20: Купить в кредит. Ввод невалидных данных (цифры) в поле «Владелец»")
    ...
    @Test
    @DisplayName("21: Купить в кредит. Ввод невалидных данных (спецсимволы) в поле «Владелец»")
    ...
    @Test
    @DisplayName("22: Купить в кредит. Ввод невалидных данных (русские буквы) в поле «Владелец»")
